"""
Django settings for metallurgy project.
...
SECRET_KEY = 'django-insecure-x^-6s7)2tp_qge7a@f@o=jywbq4mf4=8rkdjwrp$o3=1(+967g'
...
MIDDLEWARE = [
    ...
    'metallurgy.apps.users.middlewares.LastActivityMiddleware',
]
...
WSGI_APPLICATION = 'metallurgy.wsgi.application'
